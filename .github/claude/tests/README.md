...
This directory contains comprehensive tests generated by Claude AI for the OpenHands project.
The tests are designed to provide good coverage and catch real bugs in your application.

## 🧪 Generated Test Files

- `use-is-on-tos-page.test.ts` - Application tests
- `extract-next-page-from-link.test.ts` - Application tests
- `is-on-tos-page.test.ts` - Application tests
- `resizable-panel.test.tsx` - Application tests
- `container.test.tsx` - Application tests
- `nav-tab.test.tsx` - Application tests
- `tab-content.test.tsx` - Application tests
- `beta-badge.test.tsx` - Application tests
- `connect-to-provider-message.test.tsx` - Application tests
